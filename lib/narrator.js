...
async function narrateDay({ narrative, day, players, locations, actionReports, sceneHandoff }) {
...
Do NOT describe what they did this day. Instead, end your prose with one short transitional sentence that hands off to their scene — gesture at where they have wandered and that something is about to happen there. Example shape: "Meanwhile, ${sceneHandoff.names[0]} picks along ${sceneHandoff.names.length === 1 ? 'a stretch of shore that catches the eye of someone... unusual' : 'an unfamiliar shore'}." Match the tone you've established. The transition is the LAST sentence of your output.
</scene-handoff>`
    : '';
  const userMessage = `<story-so-far>
${narrative || '(empty)'}

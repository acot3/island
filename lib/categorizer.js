...
For each action, judge five things:
...
5. A one-sentence rationale explaining your judgment, useful for debug and downstream narration.
...
const TOOL = {
  ...
  input_schema: {
    ...
    required: ['possible', 'attribute', 'difficulty', 'seeking', 'rationale'],
  },
};
